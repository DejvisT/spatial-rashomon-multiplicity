...
Model family explains a substantial share of predictive variance, especially on Adult and
COMPAS, and this contribution often increases inside HH regions. Within model families,
disagreement is further shaped by a smaller number of influential hyperparameters, such
as regularization strength for logistic regression, neighborhood size for kNN, and
complexity or optimization parameters for tree-based and neural-network models.
Predictive multiplicity is therefore not just random training variation; it is structured by
