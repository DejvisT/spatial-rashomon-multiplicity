...
\cite{hsu_rashomongb_2024} extend this line in the context of gradient boosting, introducing RashomonGB as a practical method for inspecting and mitigating predictive multiplicity in boosted models.
...
test points, but with a mitigation rather than diagnostic goal: their local patching and reconciliation methods aim
to reduce disagreement among Rashomon-set models. In contrast, this thesis treats local
structure as the object of diagnosis, testing whether predictive variance is spatially
autocorrelated in feature space and whether high-multiplicity regions recur as graph-based
hotspots.
...
then analyzes whether high-disagreement observations cluster locally. The goal is therefore to measure how much predictive
multiplicity exists, locate where it occurs, assess how stable these regions
