...
In addition to variance-based Moran's $I$, we repeat the null experiment using the pointwise conflict ratio $c_i$ (Section~3.4) as the spatial variable.  This tests whether hard-label disagreement---a complementary measure to soft prediction variance---also exhibits significant spatial clustering.
...
Pred.\ multiplicity & Disagreement rate ($\delta=0.05$) & $0.27 \pm 0.18$ \\
