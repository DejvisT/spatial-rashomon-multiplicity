...
To test whether spatial multiplicity is driven by probability miscalibration, Platt scaling was applied as described in Section~\ref{sec:exp-calibration}: a logistic regression is fit on each model's validation-set predictions, then applied to test-set predictions.  Multiplicity metrics (including both variance and conflict ratio) were recomputed on the calibrated predictions.  Table~\ref{tab:calibration_summary} summarizes the changes.
